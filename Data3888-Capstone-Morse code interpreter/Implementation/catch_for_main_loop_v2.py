...
pathlist_1 = [str(der) + "/blink_olli_bot_v1.wav",
        str(der) + "/blinking_jack_top_v1.wav",
        str(der) + "/blinking_jack_top_v2.wav",
        str(der) + "/blinking_ollie_top_v1.wav"]
pathlist_2 = [str(der) + "/longblinkinh_ollie_bot_v2.wav",
        str(der) + "/longblink_olli_top_v1.wav",
        str(der) + "/longblink_jack_top_v1.wav"]
pathlist_3 = [str(der) + "/doubleblink_jack_top_v1.wav",
        str(der) + "/doublelink_jack_bot_v1.wav",
        str(der) + "/doublelink_jack_bot_v2.wav",
        str(der) + "/doublelink_jack_top_v2.wav"]
